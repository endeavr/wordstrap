...
if (!is_admin())
{
	...
	wp_enqueue_style('bs_less_custom', get_template_directory_uri().'/themes/wordstrap/less/bootstrap.custom.less', array(), '1.0', 'screen,projection');
	wp_enqueue_style('bs_responsive_custom', get_template_directory_uri().'/themes/wordstrap/less/responsive.custom.less', array(), '1.0', 'screen,projection');
