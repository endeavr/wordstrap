...
(function(){
	...
	var icon_url = '<?php echo $plugin_url; ?>' + '/ws_icon.png';

	tinymce.create(
		"tinymce.plugins.WordStrapShortcodes",
		{
			init: function(d,e) {
					
					
					
					d.addCommand( "wordstrapOpenDialog",function(a,c){
						...
						wordstrapSelectedShortcodeType = c.identifier;
						wordstrapSelectedShortcodeTitle = c.title;
						
						jQuery.get(e+"/dialog.php",function(b){
							
							var a;
							
							jQuery('#wordstrap-shortcode-options').addClass( 'shortcode-' + wordstrapSelectedShortcodeType );
							...
							switch ( wordstrapSelectedShortcodeType ) {
								...
								ws_show("Insert WordStrap "+ wordstrapSelectedShortcodeTitle +" Shortcode", "#WS_inline?width="+f+"&height="+b+"&inlineId=wordstrap-dialog");jQuery("#wordstrap-shortcode-options h3:first").text(""+c.title+" Shortcode Settings");
				...
				createControl:function(d,e){
						...
						if(d=="wordstrap_shortcodes_button"){
						
							d=e.createMenuButton("wordstrap_shortcodes_button",{
								title:"Insert WordStrap Shortcode",
								image:icon_url,
								icons:false
								});
				...
				addWithDialog:function(d,e,a){d.add({title:e,onclick:function(){tinyMCE.activeEditor.execCommand("wordstrapOpenDialog",false,{title:e,identifier:a})}})},
		
				getInfo:function(){ return{longname:"WordStrap Shortcode Generator",author:"VisualShortcodes.com",authorurl:"http://visualshortcodes.com",infourl:"http://visualshortcodes.com/shortcode-ninja",version:"1.0"} }
			}
		);
		
		tinymce.PluginManager.add("WordStrapShortcodes",tinymce.plugins.WordStrapShortcodes)
	}
)();
