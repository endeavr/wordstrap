<?php
/**
 * WordStrap Twitter Widget
 * 
 * @package WordStrap WordPress Framework
 * @author Jason Loftis
 */

class WS_Widget_Twitter extends WP_Widget {
	
	/* Constructor */
	
	function __construct() {
		$widget_ops = array(
			'classname' => 'ws-twitter_widget', 
			'description' => 'Show recent tweets from a Twitter account.'
		);
        $this->WP_Widget( 'wordstrap_twitter_widget', 'WordStrap Twitter', $widget_ops );
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('username'); ?>"><?php _e( 'Enter your twitter username:', WS_GETTEXT_DOMAIN ); ?> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'How many entries do you want to display:', WS_GETTEXT_DOMAIN ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('exclude_replies'); ?>"><?php _e( 'Exclude @replies:', WS_GETTEXT_DOMAIN ); ?> </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('time'); ?>"><?php _e( 'Display time of tweet', WS_GETTEXT_DOMAIN ); ?> </label>
	...
	function widget($args, $instance) {
		...
		wordstrap_twitter( $count, $username, $time, $exclude_replies );
		echo $after_widget;	
	}

}
register_widget('WS_Widget_Twitter');