<?php
/**
 * WordStrap Simple Contact Widget
 * 
 * @package WordStrap WordPress Framework
 * @author Jason Loftis
 */

class WS_Widget_Contact extends WP_Widget {
	
	/* Constructor */
	
	function __construct() {
		$widget_ops = array(
			'classname' => 'ws-contact_widget', 
        ...
        $this->WP_Widget( 'wordstrap_contact_widget', 'WordStrap Simple Contact', $widget_ops, $control_ops );
	}
	...
	function form($instance) {
		...
		$icons = apply_filters( 'wordstrap_simple_contact_icons', $icons );
        ?>
		<p class="description"><?php _e( 'All fields are optional. Only fill in the items you want to show.', WS_GETTEXT_DOMAIN ); ?></p>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', WS_GETTEXT_DOMAIN); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('phone_1'); ?>"><?php _e('Phone #1:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('phone_2'); ?>"><?php _e('Phone #2:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('email_1'); ?>"><?php _e('Email Address #1:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('email_2'); ?>"><?php _e('Email Address #2:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('contact'); ?>"><?php _e('URL to Contact Page:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('skype'); ?>"><?php _e('Skype Username:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<h4><?php _e( 'Icon Links', WS_GETTEXT_DOMAIN ); ?></h4>
		<div style="border: 1px solid #cccccc; margin: 0 0 5px 0; padding: 8px;">
			<p>
				<label for="<?php echo $this->get_field_id('link_1_icon'); ?>"><?php _e('Link #1 Icon:', WS_GETTEXT_DOMAIN); ?></label>
			...
			<p>	
				<label for="<?php echo $this->get_field_id('link_1_url'); ?>"><?php _e('Link #1 URL:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<div style="border: 1px solid #cccccc; margin: 0 0 5px 0; padding: 8px;">
			<p>
				<label for="<?php echo $this->get_field_id('link_2_icon'); ?>"><?php _e('Link #2 Icon:', WS_GETTEXT_DOMAIN); ?></label>
			...
			<p>	
				<label for="<?php echo $this->get_field_id('link_2_url'); ?>"><?php _e('Link #2 URL:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<div style="border: 1px solid #cccccc; margin: 0 0 5px 0; padding: 8px;">
			<p>
				<label for="<?php echo $this->get_field_id('link_3_icon'); ?>"><?php _e('Link #3 Icon:', WS_GETTEXT_DOMAIN); ?></label>
			...
			<p>	
				<label for="<?php echo $this->get_field_id('link_3_url'); ?>"><?php _e('Link #3 URL:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<div style="border: 1px solid #cccccc; margin: 0 0 5px 0; padding: 8px;">
			<p>
				<label for="<?php echo $this->get_field_id('link_4_icon'); ?>"><?php _e('Link #4 Icon:', WS_GETTEXT_DOMAIN); ?></label>
			...
			<p>	
				<label for="<?php echo $this->get_field_id('link_4_url'); ?>"><?php _e('Link #4 URL:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<div style="border: 1px solid #cccccc; margin: 0 0 5px 0; padding: 8px;">
			<p>
				<label for="<?php echo $this->get_field_id('link_5_icon'); ?>"><?php _e('Link #5 Icon:', WS_GETTEXT_DOMAIN); ?></label>
			...
			<p>	
				<label for="<?php echo $this->get_field_id('link_5_url'); ?>"><?php _e('Link #5 URL:', WS_GETTEXT_DOMAIN); ?></label>
		...
		<div style="border: 1px solid #cccccc; margin: 0 0 5px 0; padding: 8px;">
			<p>
				<label for="<?php echo $this->get_field_id('link_6_icon'); ?>"><?php _e('Link #6 Icon:', WS_GETTEXT_DOMAIN); ?></label>
			...
			<p>	
				<label for="<?php echo $this->get_field_id('link_6_url'); ?>"><?php _e('Link #6 URL:', WS_GETTEXT_DOMAIN); ?></label>
	...
	function widget($args, $instance) {
		...
		echo wordstrap_get_simple_contact( $instance );
		echo $after_widget;		
	}

}
register_widget('WS_Widget_Contact');