<?php
/**
 * WordStrap Mini Post Grid Widget
 * 
 * @package WordStrap WordPress Framework
 * @author Jason Loftis
 */

class WS_Widget_Mini_Post_Grid extends WP_Widget {
	
	/* Constructor */
	
	function __construct() {
		$widget_ops = array(
			'classname' => 'ws-mini_post_grid_widget', 
        ...
        $this->WP_Widget( 'wordstrap_mini_post_grid_widget', 'WordStrap Mini Post Grid', $widget_ops, $control_ops );
	}
	...
	function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Title:', WS_GETTEXT_DOMAIN ); ?> 
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('thumb'); ?>"><?php _e( 'Thumbnail Sizes:', WS_GETTEXT_DOMAIN ); ?> </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('align'); ?>"><?php _e( 'Thumbnail Alignment:', WS_GETTEXT_DOMAIN ); ?> </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('category'); ?>"><?php _e( 'Category:', WS_GETTEXT_DOMAIN ); ?> </label>
			<select class="widefat" id="<?php echo $this->get_field_id('category'); ?>" name="<?php echo $this->get_field_name('category'); ?>">
				<?php 
				$list = null;
				$answers = array( 'all' => __( 'All Categories', WS_GETTEXT_DOMAIN ) );
		...
		<p>
			<label for="<?php echo $this->get_field_id('numberposts'); ?>"><?php _e( 'Number of Posts:', WS_GETTEXT_DOMAIN ); ?> 
		...
		<div style="border: 1px solid #cccccc; margin: 0 0 5px 0; padding: 8px;">
			<p>
				<label for="<?php echo $this->get_field_id('query'); ?>"><strong><?php _e( 'Custom query string (optional)', WS_GETTEXT_DOMAIN ); ?></strong>
			...
			<p><?php _e( 'Here you can enter in a custom query string formatted for WordPress\'s <a href="http://codex.wordpress.org/Template_Tags/get_posts" target="_blank">get_posts</a>.', WS_GETTEXT_DOMAIN ); ?></p>
			<p><?php _e( 'If you enter anything here, your category selection and number of posts selection above will be ignored.', WS_GETTEXT_DOMAIN ); ?></p>
			<p>
		...
		<div style="border: 1px solid #cccccc; margin: 0 0 5px 0; padding: 8px;">
			<p>
				<label for="<?php echo $this->get_field_id('gallery'); ?>"><strong><?php _e( 'Gallery override (optional)', WS_GETTEXT_DOMAIN ); ?></strong>
			...
			<p><?php _e( 'Enter the numerical ID of the post or page you want to pull attachmetns from.', WS_GETTEXT_DOMAIN ); ?></p>
			<p><?php _e( 'If you enter anything here, your category selection, number of posts selection, and custom query options will all be ignored.', WS_GETTEXT_DOMAIN ); ?></p>
		</div>
		<?php	
	}
	...
	function widget($args, $instance) {
		...
		echo wordstrap_get_mini_post_grid( $query, $instance['align'], $instance['thumb'], $instance['gallery'] );
		echo $after_widget;	
	}

}
register_widget('WS_Widget_Mini_Post_Grid');