<?php
/**
 * WordStrap Mini Post List Widget
 * 
 * @package WordStrap WordPress Framework
 * @author Jason Loftis
 */

class WS_Widget_Mini_Post_List extends WP_Widget {
	
	/* Constructor */
	
	function __construct() {
		$widget_ops = array(
			'classname' => 'ws-mini_post_list_widget', 
        ...
        $this->WP_Widget( 'wordstrap_mini_post_list_widget', 'WordStrap Mini Post List', $widget_ops, $control_ops );
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('meta'); ?>"><?php _e( 'Post Dates:', WS_GETTEXT_DOMAIN ); ?> </label>
	...
	function widget($args, $instance) {
		...
		echo wordstrap_get_mini_post_list( $query, $thumb, $meta );
		echo $after_widget;	
	}

}
register_widget('WS_Widget_Mini_Post_List');