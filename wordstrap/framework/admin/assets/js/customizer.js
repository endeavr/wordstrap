jQuery(document).ready(function($){
	...
	// "wordstrap_locals_customizer_js" to remove the text.
	// 
	// Reference: /framework/admin/functions/locals.php
	
	// Check if text is present before displaying.
	if( wordstrap.disclaimer )
	{
		$('.wp-full-overlay-sidebar-content').append('<span class="wordstrap-disclaimer">'+wordstrap.disclaimer+'</span>');
	}
