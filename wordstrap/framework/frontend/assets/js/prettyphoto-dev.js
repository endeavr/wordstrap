/* ------------------------------------------------------------------------
	...
	The WordStrap WordPress framework incorporates prettPhoto (an 
	...
	edits made by Jason Loftis. Hopefully we can get rid of this in the 
	...
	$.fn.prettyPhoto = function(pp_settings) {
		...
		*/
		function _fitToViewport(width,height){
			...
			// Create an offset variable (mod by WordStrap)
			...
			if( ((pp_containerWidth > windowWidth) || (pp_containerHeight > windowHeight)) && doresize && settings.allow_resize && !percentBased) {
				...
				while (!fitting){
					if((pp_containerWidth > windowWidth)){
						imageWidth = (windowWidth - offset); 			// Use new offset variable instead of original 200 (mod by WordStrap).
						imageHeight = (height/width) * imageWidth;
					}else if((pp_containerHeight > windowHeight)){
						imageHeight = (windowHeight - offset);			// Use new offset variable instead of original 200 (mod by WordStrap).
				...
				// Wrap this in an IF statement to check device width first. (mod by WordStrap)
