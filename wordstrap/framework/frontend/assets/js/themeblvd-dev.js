...
jQuery(document).ready(function($) {
	...
	$('.gallery').each(function(){
		...
		current_gallery.find('.gallery-item a').each(function(){
			if(this.href.match(/\.(jpe?g|png|bmp|gif|tiff?)$/i)){
			    $(this).attr('rel','wordstrap_lightbox['+gallery_id+']');
	...
	$('a[rel^="wordstrap_lightbox"], a[rel^="featured_wordstrap_lightbox"]').prettyPhoto({
	...
	$('a[rel^="wordstrap_lightbox"]').prepend('<span class="enlarge"></span>');
	
	$('a[rel^="wordstrap_lightbox"]').hover(
		function () {
			var el = $(this);
	...
	$('.ws-tabs').each(function(){
		var el = $(this);
		el.find('.tab-content').hide();
		el.find('.tab-content:first').show();
	});
    $('.ws-tabs .tab-nav a').click(function() {
		var el = $(this), parent = el.closest('.ws-tabs'), activetab = el.attr('href');
	...
	$('.ws-toggle').each(function(){
		$(this).find('.toggle-content').hide();
	});
	$('.ws-toggle a.toggle-trigger').click(function(){
		var el = $(this), parent = el.closest('.ws-toggle');
	...
	$(".ws-jump-menu").change(function(e) {
