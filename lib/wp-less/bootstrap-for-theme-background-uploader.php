...
// Background Colors + Patterns
	...
	$ws_bodyUpload = of_get_option('ws_bodyupload');
		if ( $ws_bodyOption == 'color' ) {
	    	...
	    	if ( $ws_bodyOption == 'colorpattern' ) {
	    		$WPLessPlugin->addVariable('@bodyBackground', $ws_bodyBackground);
			$WPLessPlugin->addVariable('@bodyPattern', '../../img/patterns/'.$ws_bodyPattern.'.png');
			$WPLessPlugin->addVariable('@bodyRepeat', 'repeat');
		};
	    	if ( $ws_bodyOption == 'upload' ) {
	    		$ws_bodyUploadColor = $ws_bodyUpload['color'];
	    		$ws_bodyUploadImage = $ws_bodyUpload['image'];
	    		$ws_bodyUploadRepeat = $ws_bodyUpload['repeat'];
	    		$WPLessPlugin->addVariable('@bodyBackground', $ws_bodyUploadColor);
			$WPLessPlugin->addVariable('@bodyPattern', $ws_bodyUploadImage);
			$WPLessPlugin->addVariable('@bodyRepeat', $ws_bodyUploadRepeat);
		};				
	...
	$ws_wrapUpload = of_get_option('ws_wrapupload');
		if ( $ws_wrapOption == 'transparent' ) {
			$WPLessPlugin->addVariable('@wrapBackground', 'transparet');
		...
		if ( $ws_wrapOption == 'colorpattern' ) {
			$WPLessPlugin->addVariable('@wrapBackground', $ws_wrapBackground);
			$WPLessPlugin->addVariable('@wrapPattern', '../../img/patterns/'.$ws_wrapPattern.'.png');
			$WPLessPlugin->addVariable('@wrapRepeat', 'repeat');
		};
	    	if ( $ws_wrapOption == 'upload' ) {
	    		$ws_wrapUploadColor = $ws_wrapUpload['color'];
	    		$ws_wrapUploadImage = $ws_wrapUpload['image'];
	    		$ws_wrapUploadRepeat = $ws_wrapUpload['repeat'];
	    		$WPLessPlugin->addVariable('@bodyBackground', $ws_wrapUploadColor);
			$WPLessPlugin->addVariable('@bodyPattern', $ws_wrapUploadImage);
			$WPLessPlugin->addVariable('@bodyRepeat', $ws_wrapUploadRepeat);
		};			
